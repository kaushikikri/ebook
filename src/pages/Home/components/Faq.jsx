...
export const Faq = () => {
  ...
  return (
    ...
    <section className="border dark:border-gray-700 mb-10 mt-20 rounded-lg">
      <h2 className="text-2xl text-center font-medium underline mt-4 dark:text-slate-100 ">Question in mind?</h2>

      <div className="p-4" id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
        {faqs.map((faq) => (<Question key={faq.id} faq={faq} />))}
